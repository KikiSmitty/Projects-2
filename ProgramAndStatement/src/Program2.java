...
public class Program2 extends ProgramSecondary {
    ...
    public final Map<String, Statement> newContext() {
        ...
        //returns a new instance of the context map
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        //creates temporary context to hold the existing context
        Map<String, Statement> temp = this.context.newInstance();

        //transfers current context to temporary variable
        temp.transferFrom(this.context);

        //transfers new context into the programs context
        this.context.transferFrom(c);

        //transfers old context back into the provided context
        c.transferFrom(temp);
    ...
    public final void swapBody(Statement b) {
        ...
        //temporary variable to store existing body
        Statement temp = this.body.newInstance();

        //transfers current body to the temporary variable
        temp.transferFrom(this.body);

        //assigns new body to the programs body
        this.body.transferFrom(b);

        //restores original body
        b.transferFrom(temp);
