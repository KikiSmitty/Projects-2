 ...
 *
 * @author Katie Beatty, Kierra Smith, Maggie Tiernan
 *
 */
public abstract class ListTest {
    ...
    /**
     * testing retreat when the left has one element and the right is empty.
     */
    @Test
    ...
    /**
     * testing retreat when the left has one element and the right has one
     * element.
     */
    @Test
    ...
    /**
     * testing retreat when the left has one element and the right has more than
     * 1 one element.
     */
    @Test
    public void testRetreat3() {
        List<String> list1 = this.createFromArgsTest(1, "red", "yellow", "green", "blue",
                "purple");
        List<String> list2 = this.createFromArgsRef(0, "red", "yellow", "green", "blue",
                "purple");
    ...
    /**
     * testing retreat when the left has more than one element and the right has
     * one element.
     */
    @Test
    public void testRetreat4() {
        List<String> list1 = this.createFromArgsTest(4, "red", "yellow", "green", "blue",
                "purple");
        List<String> list2 = this.createFromArgsRef(3, "red", "yellow", "green", "blue",
                "purple");
    ...
    /**
     * testing retreat when the left has more than one element and the right is
     * empty.
     *
     */
    @Test
    public void testRetreat5() {
        List<String> list1 = this.createFromArgsTest(5, "red", "yellow", "green", "blue",
                "purple");
        List<String> list2 = this.createFromArgsRef(4, "red", "yellow", "green", "blue",
                "purple");
     ...
     */
    @Test
    public void testRetreat6() {
        List<String> list1 = this.createFromArgsTest(3, "red", "yellow", "green", "blue",
                "purple");
        List<String> list2 = this.createFromArgsRef(2, "red", "yellow", "green", "blue",
                "purple");
